...
<Note>
OpenTelemetry-compatible backends including MLflow, Arize Phoenix, Langfuse, Langsmith, Langtrace, Logfire, Maxim, OpenLIT, and Weave are supported by Agno out of the box.
</Note>
